...
public class Button {
	...
	private String note;
	private int rifling_count;
	
	private float major_dia;
	private float minor_dia;
	private String rifling_type;
	private float rifling_width = 0.0f;
	private float shaft_size;
	private float button_shank_size;
	...
	public float getMajor_dia() {
		return major_dia;
	}
	public void setMajor_dia(float major_dia) {
		this.major_dia = major_dia;
	}
	public float getMinor_dia() {
		return minor_dia;
	}
	public void setMinor_dia(float minor_dia) {
		this.minor_dia = minor_dia;
	}
	public float getRifling_width() {
		return rifling_width;
	}
	public void setRifling_width(float rifling_width) {
		this.rifling_width = rifling_width;
	}
	public float getShaft_size() {
		return shaft_size;
	}
	public void setShaft_size(float shaft_size) {
		this.shaft_size = shaft_size;
	}
	public float getButton_shank_size() {
		return button_shank_size;
	}
	public void setButton_shank_size(float button_shank_size) {
		this.button_shank_size = button_shank_size;
	}
	...
	public int getRifling_count() {
		return rifling_count;
	}
	public void setRifling_count(int rifling_count) {
